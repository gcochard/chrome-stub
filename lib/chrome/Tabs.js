...
function Tabs(chrome) {
   ...
   * @param {function} callback
   */
  this.getAllInWindow = sinon.stub();
   ...
   * @param {function} callback
   */
  this.captureVisibleTab = sinon.stub();
   ...
   */
  this.setZoomSettings = sinon.stub();
   ...
   */
  this.getZoomSettings = sinon.stub();
